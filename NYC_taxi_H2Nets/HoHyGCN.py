...
class HoHyGCNGCN(nn.Module):
    ...
    def forward(self, x, x_e, x_time, x_window, node_embeddings, hodge_laplacian, incidence_matrix, hyper_edge_data, hyper_node_data):
        ...
        x_node_hyper = self.enc_node(x_node_hyper, hyper_edge_data, size = [200, 32]) #B, N, dim_out/?
        ...
        x_edge_hyper = self.enc_edge(x_edge_hyper, hyper_node_data, size=[100, 26])  #B, M, dim_out/?
