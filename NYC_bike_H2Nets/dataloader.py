...
from load_dataset import load_bike_dataset, load_hyperedge, load_hypernode, load_time_dataset, load_edge_dataset, load_Hodge_Laplacian, load_incidence_matrix
...
def get_hyper_dataloader(args, type, hyper_data_type):
    ...
    data_train, data_test = load_bike_dataset(type)
